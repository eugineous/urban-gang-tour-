...
export function MobileApp() {
  ...
  return <main className="ugt-mobile-app">
    <header className="ugt-mobile-top"><Link href="/" aria-label="Urban Gang Tour"><img src="/uploads/URBAN%20GANG%20TOUR%20OFFICIAL%20LOGO.png" alt="Urban Gang Tour" /></Link><button className="ugt-mobile-bag" onClick={() => setBagOpen(true)}>Bag <b>{bag.length}</b></button></header>
