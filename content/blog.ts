...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    teaser:
      "PCEA Gituamba Girls closed our second-term hat-trick with showcases across every discipline, a full runway, and a crowning the school will be talking about for terms.",
    ...
    paras: [
      "Some schools warm up slowly. Gituamba did not. By the time the first showcase category opened, the crowd had already decided this was their day, and every competitor who touched the mic got the kind of reception artists tour years to earn.",
      "Every showcase category ran - music, dance, spoken word, poetry slam, comedy, drama, news reporting, and the modelling runway. The runway, directed by Synapse Models, went through cultural wear, creative wear, cosplay, and professional wear before the day closed with the crowning of Mrs/Miss of the Institution, presented by the school's leadership alongside Eugine and Lucy.",
      "Between showcases, the Urban Pods ran through the day - picked from our five themes to fit what Gituamba's students wanted to talk about most. The Mind Your Mind sessions filled up first. They usually do.",
  ...
  },
  {
    ...
    paras: [
      ...
      "The showcases were close in every category, but the runway stole the day. Synapse Models had the walkers moving like a Fashion Week call sheet - cultural wear that brought the loudest cheers of the morning, and a professional wear round that looked like a corporate takeover in the best way.",
  ...
  },
  {
    ...
    paras: [
      ...
      "The showcases opened with music and never let the energy dip - by the comedy round, teachers were laughing harder than students. The news reporting category produced anchors so composed the Urban News hosts started taking notes. And the runway crowning closed the day with the whole school on its feet.",
